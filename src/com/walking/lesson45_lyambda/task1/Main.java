package com.walking.lesson45_lyambda.task1;

import com.walking.lesson45_lyambda.task1.model.Car;
...
public class Main {
    public static void main(String[] args) {
        ...
        Comparator<Car> yearComparator = Comparator.comparing(o -> o.getIdentifier().getYear());
