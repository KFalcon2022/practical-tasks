...
import com.walking.lesson47_method_reference.task3.domain.filter.*;
...
public class MenuService {
    ...
    public void processMainMenu() {
        ...
        while (!isExit) {
            ...
            String mainMenuItem = inputService.getLine();
            MainMenuItem item = mappingService.mapMainMenuItem(mainMenuItem);
            ...
            switch (item) {
                ...
                case INCORRECT_INPUT -> messagePrinterService.printIncorrectInputMessage();
    ...
    private void processSearch(CarFilter filter) {
        Set<Car> cars = carService.findCars(filter::filter);
