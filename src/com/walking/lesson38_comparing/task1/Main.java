...
import com.walking.lesson38_comparing.task1.comparators.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Comparator<Car> compNumber = new CarNumberComparator();
        carsArray.sort(compNumber);
        System.out.println("\nSort by plate number\n");
        displayArray();

        Comparator<Car> compBrandName = new CarBrandNameComparator();
        carsArray.sort(compBrandName);
        System.out.println("\nSort by brand name\n");
        displayArray();

        Comparator<Car> compVIN = new CarVinComparator();
        carsArray.sort(compVIN);
        System.out.println("\nSort by VIN\n");
        displayArray();

        Comparator<Car> compNumberVIN=new CarNumberComparator().thenComparing(new CarVinComparator());
