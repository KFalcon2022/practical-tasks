...
//        можно было обойтись обычной конкатенацией строк
    ...
    public int compareTo(Car c) {
        ...
        return identifier.getNumber().compareTo(c.identifier.getNumber()) == 0 ?
                identifier.getYear() - c.identifier.getYear() :
                identifier.getNumber().compareTo(c.identifier.getNumber())
                ;
    }
}
