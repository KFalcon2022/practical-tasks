...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Counter temp=counterService.getCounterByName(COLD_WATER_COUNTER_NAME);
        counterService.removeCounter(counterService.getCounterByName(COLD_WATER_COUNTER_NAME));
        printCounterValues(counterService.getAllCounters());

        counterService.addCounter(1, temp);
        printCounterValues(counterService.getAllCounters());
    }
