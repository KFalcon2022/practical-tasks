package com.walking.lesson19_obkects_methods.task1;

import com.walking.lesson19_obkects_methods.task1.model.Brand;
import com.walking.lesson19_obkects_methods.task1.model.Car;
    ...
    public static void main(String[] args) {
        ...
        for (Car car : cars) {
            if (car.equals(desiredCar)) { //Сравнение оп переопределенному методу сравнения equal
                System.out.println("Вам подойдет эта машина: "+car.brand + " цвет " + car.color + " макс. скорость " + car.maxSpeed);
                result = true;
            }
        }
        ...
        if (!result) {
            ...
            for (Car car : cars) {
                if (car != null) {
                    System.out.println(car.brand + " цвет " + car.color + " макс. скорость " + car.maxSpeed);
                }
            }
        }
