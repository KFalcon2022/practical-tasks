...
public class InputValidationService {
    public static final String MAIN_MENU_VALIDATION_REGEX = "^[0-4]$";
    public static final String YEAR_VALIDATION_REGEX = "^[0-9]{4}";
    public static final int MIN_AVAILABLE_REGEX = 1900;
    public static final int MAX_AVAILABLE_REGEX = LocalDate.now().getYear();
    ...
    public boolean isMinYearInputValid(String firstYearInput) {
        return isMaxYearInputValid(firstYearInput, MIN_AVAILABLE_REGEX);
    }
    ...
    public boolean isMaxYearInputValid(String firstYearInput, int firstYear) {
        ...
        return firstYear <= year && year <= MAX_AVAILABLE_REGEX;
    }
}
