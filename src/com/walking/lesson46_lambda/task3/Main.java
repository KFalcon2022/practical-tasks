...
import com.walking.lesson46_lambda.task3.exception.UnableParsingException;
import com.walking.lesson46_lambda.task3.model.Car;
import com.walking.lesson46_lambda.task3.model.CarFilter;
import com.walking.lesson46_lambda.task3.service.CarFilterService;
        ...
        return switch (commandName) {
            ...
            case "search" -> {
                if (!isValidArguments(arguments)) {
                    ...
                    List<Car> foundCars = carService.findBy(carFilterService.getPredicate());
