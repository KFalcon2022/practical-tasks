package com.walking.lesson58.Task3;
...
public class Main {
    public static void main (String[] args){
        ...
        HashMap<String, Integer> elders = getElders(employees);
    ...
    public static HashMap<String, Integer> getElders(List<Employee> employees) {
        var temp = new HashMap<String, Integer>();

        employees.forEach(e -> {
            temp.computeIfAbsent(e.getName(), v -> 0);
            temp.merge(e.getName(), e.getAge(), (a, b) -> a + b);
        });
