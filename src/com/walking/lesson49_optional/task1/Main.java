...
public class Main {
    public static void main(String[] args) {
        ...
        CarIdentifier car = initCar();

        carService.findCar(car)
                .ifPresentOrElse(
                        System.out::println,
    ...
    private static CarIdentifier initCar() {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter a number car: ");
        String number = scanner.nextLine();

        System.out.print("Enter a year car: ");
