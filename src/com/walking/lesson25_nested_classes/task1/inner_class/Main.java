...
import com.walking.lesson25_nested_classes.task1.inner_class.model.EquilateralShapeCreateble;
...
//        ради демонстрации ситуации, когда скобки в условном выражении действительно необходимы
    ...
    private static String createShapeString(int length, int type) {
        EquilateralShapeCreateble shape = new EquilateralShapeCreateble();

        switch (type) {
            case 1:
                EquilateralShapeCreateble.Square square = shape.new Square(length);
                return square.createShapeString();
            case 2:
                EquilateralShapeCreateble.EquilateralTriangle triangle = shape.new EquilateralTriangle(length);
