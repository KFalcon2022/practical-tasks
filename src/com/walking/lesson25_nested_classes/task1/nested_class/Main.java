...
import com.walking.lesson25_nested_classes.task1.nested_class.interfaces.RightShapeInterface;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        new Main().createFigure(chosenShapeNumber, chosenShapeSize);
    }

    private void createFigure(int shapeType, int sideSize) {
        switch (shapeType) {
            case (1) -> {
    ...
    private class Square implements RightShapeInterface {
    ...
    private class Triangle implements RightShapeInterface{
        private final int length;
