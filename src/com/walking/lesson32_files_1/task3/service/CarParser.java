...
import com.walking.lesson32_files_1.task3.exception.UnableParsingException;
import com.walking.lesson32_files_1.task3.exception.RegexValidationException;
...
public class CarParser {
    ...
    public Car[] parseAllCars() {
        ...
        String[] carCandidates = input.split(CAR_SEPARATOR);
    ...
    public Car parseSingleCar(String carCandidate) {
        String[] fields = carCandidate.split(CAR_FIELD_SEPARATOR);
