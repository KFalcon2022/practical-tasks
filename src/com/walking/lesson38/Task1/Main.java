...
public class Main {
    ...
    public static void main(String[] args){
        ...
        for (Car car : DB.itemsSortedByModel()){System.out.println(car);}

        System.out.println("\nСортировка по имени владельца:");
        for (Car car : DB.itemsSortedByOwner()){System.out.println(car);}

        System.out.println("\nСортировка по имени году и номеру:");
        for (Car car : DB.itemsSortedByYearNumber()){System.out.println(car);}
    }
}
